...
mram::mram(uint8_t ss_Pin,uint8_t newHoldPin)
{
	/*
...
uint8_t mram::changeDevice  (uint8_t ss_Pin,uint8_t newHoldPin)
{
	/*
...
// .. read just one byte
uint8_t mram::readByte(uint16_t address) 
{
	/*
...
void mram::readBuffer(uint16_t address, char *buffer, uint16_t length) 
{
	/*
...
void mram::writeBuffer(uint16_t address, char *buffer, uint16_t length)
{
	/*
...
void mram::fillBytes(uint16_t address, uint8_t value, uint16_t length) {
	/*
...
void mram::setAddressMode(uint16_t address, uint8_t command) 
{
	/*
